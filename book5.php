...
<body>
<header>
    <a href="homepage.php"><img src="images/wonderlogo.png" alt="Logo" id="logo" style="width: 100px; height: auto;"></a>
...
<div class="box">
  <h2>Dylan The Dragon</h2>
  <img src="images/book5.jpg" alt="" style="width: 200px">

  <h4>About The Book</h4>
  <p>In this classic tale, Dylan learns to make friends despite obstacles.  And when the happily ever  after arrives, both the dragon and  the reader have learnt a thing or two about relationships.</p>

  <div>
      <a href="https://cdn.shopify.com/s/files/1/2081/8163/files/011-DYLAN-THE-DRAGON-Free-Childrens-Book-By-Monkey-Pen.pdf?v=1589884746" download>Read the book here</a>
  </div>
</div>
