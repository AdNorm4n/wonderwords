...
<div class="box">
    <h2>Hide And Seek</h2>
    <img src="images/book1.png" alt="" style="width: 200px">

    <h4>About The Book</h4>
    <p>Was it just another game of hide and seek? No. It was not. First, she fell into a deep, dark hole in the ground and then they found a treasure. Did it end there? No! It did not. Read more about this thrilling adventure of Sally and friends in this free illustrated kids’ book. The fun never ends when Sally’s around!</p>

    <div>
        <a href="https://cdn.shopify.com/s/files/1/2081/8163/files/001-HIDE-AND-SEEK-Free-Childrens-Book-By-Monkey-Pen.pdf?v=1589846897" download>Read the book here</a>
    </div>
</div>
